...
var knockout = __webpack_require__(63);
var jquery = __webpack_require__(5);
__webpack_require__(62);
var ContactForm = /** @class */ (function () {
    function ContactForm(ko, $) {
        var _this = this;
        this.ko = ko;
        this.$ = $;
        this.init = function () {
            _this.$("document").ready(function () {
                _this.ko.applyBindings(_this.contactData);
                _this.$("#contactForm").validate({});
            });
        };
        this.sendEmail = function () {
            if (_this.$("#contactForm").valid()) {
                console.log(_this.contactData.name());
            }
        };
        this.contactData = {
